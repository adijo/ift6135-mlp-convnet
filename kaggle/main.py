...
def main():
    ...
    model = neuralnets.KaggleNetSimple2(num_classes).to(device)
    ...
    for epoch in range(num_epochs):
        train(model, device, total_step, train_loader, criterion, optimizer, batch_size_train, logfile, epoch, num_epochs)
...
def train(model, device, total_step,  train_loader, criterion, optimizer, batch_size, logfile, epoch, num_epochs):
